...
const About = () => {
    return (
        <div>
            <div>
                <h1 className="top-text">Check out uni course entry requirements now, to see how the subjects and qualifications you choose now will affect the courses open to you later. </h1>
            </div>
            <div className="row">
                <div className="col-md-3"></div>
                <div className="col-md-9">
                    <h1 className="headers">Where to start</h1>
                    <p className="text-left">If you have any ideas about HE courses you might want to study, it’s worth doing a bit of research now.</p>
